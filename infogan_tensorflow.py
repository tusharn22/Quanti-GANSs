...
for it in range(1500000):
    ...
    X_mb, _ = mnist.train.next_batch(mb_size, shuffle=False)
...
for it in range(0, 10):
    ...
    for idx in range(1001):
        ...
        name = str(idx) + str(it)
        plt.savefig('final/{}.png'.format(name.zfill(5)), bbox_inches='tight')
        plt.close(fig)
